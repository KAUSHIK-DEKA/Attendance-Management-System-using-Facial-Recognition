...
def TakeImage(l1, l2, haarcasecade_path, trainimage_path, message, err_screen,text_to_speech):
    if (l1 == "") and (l2==""):
        ...
        try:
            ...
            print("After opening camera:", cam.isOpened())
            if not cam.isOpened():
            ...
            with open(
                ...
                "C:\\Users\\Kaushik Deka\\Desktop\\IPML\\Attendance-Management-system-using-face-recognition\\StudentDetails\\studentdetails.csv",
                "a+",
            ) as csvFile:
